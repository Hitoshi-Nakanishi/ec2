...
class DN(object):
    ...
    def zeroEverything(self):
        if self.gradient is None and self.descendents == [] and (self.data is None or self.arguments == []):
            return
    ...
    def restartingOptimize(
        ...
        for _ in range(attempts):
            ...
            ls.append(self.resilientBackPropagation(parameters, lr=lr, steps=steps, decay=decay, grow=grow))
        return min(ls)
