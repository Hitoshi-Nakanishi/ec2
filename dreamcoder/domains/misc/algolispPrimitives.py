    ...
    return (
        [
            ...
            Primitive(
                ...
                lambda f: lambda sx: ["lambda1", [f] + sx] if type(sx) == list else ["lambda1", [f] + [sx]],
            ),
            Primitive(
                "lambda2_call",
                arrow(tfunction, tlist(tsymbol), tsymbol),
                lambda f: lambda sx: ["lambda2", [f] + sx] if type(sx) == list else ["lambda2", [f] + [sx]],
            ),
            # symbol converters:
            ...
            Primitive(
                ...
                lambda symbol: lambda symbols: symbols + [symbol] if type(symbols) == list else [symbols] + [symbol],
            ),
        ]
        + [
            # functions:
