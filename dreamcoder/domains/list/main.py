...
try:
    ...
    class LearnedFeatureExtractor(RecurrentFeatureExtractor):
        ...
        def __init__(self, tasks, testingTasks=[], cuda=False):
            self.lexicon = set(flatten((t.examples for t in tasks + testingTasks), abort=lambda x: isinstance(x, str))).union(
                {"LIST_START", "LIST_END", "?"}
            )
    ...
    print("skipped class LearnedFeatureExtractor loading")
